     ...
     [:div.wrapper
      ...
      [:div.content
       [:div.container
        ...
        На практике, это значит тут" [:b "есть"] "все необходимые инструменты:"
         [:ul
          [:li "Нормальный дизайн с продуманным UI/UX"]
          [:li "Источники данных"]
          [:li "Различные типы графиков"]
          [:li "Обычающие материалы и подсказки"]
          [:li "Community"]
          ]]

        [:p "Это значит что тут " [:b "нет"] "ничего лишнего, того что мешало бы процессу создания визуализаций:"
         [:ul
          [:li "Рекламы"]
