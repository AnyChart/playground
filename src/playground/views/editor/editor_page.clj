...
(defn page [{:keys [data sample canonical-url]}]
  (hiccup-page/html5
    ...
    [:head
     ...
     ; bootstrap
     [:link {:href "/bootstrap-4.1.3-dist/css/bootstrap-grid.min.css" :rel "stylesheet"}]
     ...
     ;[:script {:src "//ternjs.net/node_modules/acorn/dist/acorn.js"}]
     ;[:script {:src "//ternjs.net/node_modules/acorn/dist/acorn_loose.js"}]
     ;[:script {:src "//ternjs.net/node_modules/acorn/dist/walk.js"}]
     ;[:script {:src "//ternjs.net/doc/demo/polyfill.js"}]
     ;[:script {:src "//ternjs.net/lib/signal.js"}]
     ;[:script {:src "//ternjs.net/lib/tern.js"}]
     ;[:script {:src "//ternjs.net/lib/def.js"}]
     ;[:script {:src "//ternjs.net/lib/comment.js"}]
     ;[:script {:src "//ternjs.net/lib/infer.js"}]
     ;[:script {:src "//ternjs.net/plugin/doc_comment.js"}]
     [:script {:src "/tern/node_modules/acorn/dist/acorn.js"}]
     [:script {:src "/tern/node_modules/acorn/dist/acorn_loose.js"}]
     [:script {:src "/tern/node_modules/acorn/dist/walk.js"}]
     [:script {:src "/tern/doc/demo/polyfill.js"}]
     [:script {:src "/tern/lib/signal.js"}]
     [:script {:src "/tern/lib/tern.js"}]
     [:script {:src "/tern/lib/def.js"}]
     [:script {:src "/tern/lib/comment.js"}]
     [:script {:src "/tern/lib/infer.js"}]
     [:script {:src "/tern/plugin/doc_comment.js"}]

     [:script {:src "/codemirror/hints.js"}]
